// RitualActivityAttributes.swift (widget-extension copy)
// Keep in sync with Core/Services/RitualActivityAttributes.swift — ActivityKit
// matches the attributes by type name + Codable shape across targets.
